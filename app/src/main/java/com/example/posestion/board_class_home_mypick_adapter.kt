...
class board_class_home_mypick_adapter (private val hotclass: List<hotclass>):RecyclerView.Adapter<board_class_home_mypick_adapter.class_home_mypick_viewholder>(){
