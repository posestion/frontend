...
class home_listpage_adapter(private val listpagelist: List<RetrofitClient.photowell>) :
    RecyclerView.Adapter<home_listpage_adapter.listpage_ViewHolder>() {

    class listpage_ViewHolder(val binding: BoardListpageListItemBinding):
            RecyclerView.ViewHolder(binding.root){
        private val context = binding.root.context
        var heart = 0
                fun bind(listpage: RetrofitClient.photowell){
                    ...
                    itemView.setOnClickListener {
                        ...
                        intent.putExtra("heartcount",listpage.Number_of_like)
                        intent.putExtra("commentcount",listpage.Number_of_reply)
