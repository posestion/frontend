...
class board_class_view_viewpager_adapter(private var pageList: ArrayList<classview_item>) : RecyclerView.Adapter<board_class_view_viewpager_adapter.classview_viewholder>(){
